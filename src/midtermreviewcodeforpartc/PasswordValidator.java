/*
 * Created a new class to delegate the password validation. Used the run method
 * in this class and created an instance of PasswordValidator declared as  
 * "something" and using it call the run method.
 */
